...
public class project {
	...
	private void winningGame()
	{
		...
		if(b1==1 && b2==1 && b3==1)
		{
			JOptionPane.showMessageDialog(frame,"Player X is Winner","Tic Tac Toe Game: Result",JOptionPane.INFORMATION_MESSAGE);
			xCount1++;
		...
		{
			JOptionPane.showMessageDialog(frame,"Player O is Winner","Tic Tac Toe Game: Result",JOptionPane.INFORMATION_MESSAGE);
			oCount1++;
		...
		{
			JOptionPane.showMessageDialog(frame,"No one wins (Draw)","Tic Tac Toe Game: Result",JOptionPane.INFORMATION_MESSAGE);
		}
	...
	private void initialize() {
		frame = new JFrame("TIC TAC TOE Game Developed by Satyam Morankar");
		...
		btnExit.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(JOptionPane.showConfirmDialog(frame, "Confirm Do you want to exit the game ?","Tic Tac Toe Game",JOptionPane.YES_NO_OPTION)==JOptionPane.YES_NO_OPTION)
				{
					System.exit(0);
				}
			}
